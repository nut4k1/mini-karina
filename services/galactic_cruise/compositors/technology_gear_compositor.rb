...
module GalacticCruise
  module Compositors
    class TechnologyGearCompositor < BaseService
      option :context, optional: false
      
      def call
        return if context.players_count
        context.action_board_image = TilesPlacer.call(main_image: context.technology_board_image, tiles: technology_gears)
      end
